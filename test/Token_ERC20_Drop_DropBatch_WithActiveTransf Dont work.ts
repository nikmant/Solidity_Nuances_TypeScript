...
import { abi as DropBatch }  from '../artifacts/contracts/Token ERC20 Drop/DropBatch WithActiveTransf.sol/DropBatch_WithActiveTransf.json';
...
describe('Test DropBatch contract', () => {
  ...
  before(async () => {
    ...
    var newToken = await TokenERC20.deploy('AAA', 'AAA', 10_000_000_000);
    // await newToken.deployed();
    console.log('TokenERC20 deployed to:', newToken.address);
  ...
  beforeEach(async () => { 
    // const DropBatch = await ethers.getContractFactory('         ');
